  ...
  return (
    <Container>
      ...
      <Right>
        <Title>Contact</Title>
        <ContactItem>
          <LocationOn style={{ marginRight: "10px" }} /> 777 Nagoya, Batam,
          Indonesia
        </ContactItem>
        <ContactItem>
          <Phone style={{ marginRight: "10px" }} /> +62 853 8013 3381
        </ContactItem>
        <ContactItem>
          <MailOutlined style={{ marginRight: "10px" }} /> bintoro1106@gmail.com
        </ContactItem>
